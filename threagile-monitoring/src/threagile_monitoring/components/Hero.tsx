...
export const Hero = () => {
  return (
    <div className="relative h-screen min-h-screen flex items-center justify-center !bg-[#222222] overflow-hidden" style={{backgroundColor: '#222222'}}>
      {/* Background Grid */}
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="text-center animate-fade-up">
          <div className="flex justify-center mb-8">
            <Shield className="h-16 w-16 !text-[#33C3F0] animate-glow" style={{color: '#33C3F0'}} />
          </div>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Threagile Monitoring
          </h1>
          <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto">
            Secure your software with real-time threat modeling and agile security monitoring
          </p>
