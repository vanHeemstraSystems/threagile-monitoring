...
> A web application to create dashboards for [Threagil](https://threagile.io).
...
1.  **Installatieproces:**
    ...
    **Ontwikkeling met webpack:**
    If you are still developing your website, in a **afzonderlijke terminalsessie**, nadat u het bovenstaande installatieproces heeft gevolgd, doet u het volgende:
