...
1.  **عملية التثبيت:**
    ...
    **التطوير باستخدام حزمة الويب:**إذا كنت لا تزال تقوم بتطوير موقع الويب الخاص بك، في**جلسة طرفية منفصلة**, after having followed the above installation process, do this:
